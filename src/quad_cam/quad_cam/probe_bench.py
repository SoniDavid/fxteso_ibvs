...
Run it alongside `ros2 launch quad_utils hardware.launch.py`. Every report_period_s it
...
# (`imfeat_topic`): hardware.launch.py load:=synthetic remaps its real output to
...
def main(args=None):
    ...
    # the graph even though its own subscriptions are small. Must precede rclpy.init().
