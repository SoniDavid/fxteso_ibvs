...
GZ_ADD_PLUGIN(quad_gz_sim::BodyWrench,
              gz::sim::System,
              quad_gz_sim::BodyWrench::ISystemConfigure,
              quad_gz_sim::BodyWrench::ISystemPreUpdate)

GZ_ADD_PLUGIN_ALIAS(quad_gz_sim::BodyWrench, "quad_gz_sim::BodyWrench")
